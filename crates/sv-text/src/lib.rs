...
//! for the optional LLM formatting pass, and the prompt and checks for edit mode. Everything
//! here is pure and fast, because it sits on the latency path of every dictation.
#![forbid(unsafe_code)]
