...
//! (Groq, Ollama, LM Studio, any hosted service) for the formatting pass and edit mode, and
//! GitHub for the latest-release check.
#![forbid(unsafe_code)]
...
pub use chat::{chat_completion, chat_url, ChatEndpoint, ChatReply, GROQ_CHAT_URL};
