// FilePath: src/features/insights/PersonalInsights.tsx
...
/** The user's own habits: speed, output, streaks and where they dictate. */
export function PersonalInsights() {
    const { data: insights, failed } = useInsightsData(api.getInsights);

    if (!insights) return <InsightsPending failed={failed} />;
