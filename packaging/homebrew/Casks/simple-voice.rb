...
# drops the block between the unsigned-build markers when the release was Developer ID signed
# and notarized. Until a release renders it, the checksum is not pinned.
cask "simple-voice" do
    ...
    postflight do
        system_command "/usr/bin/xattr",
                       args: ["-dr", "com.apple.quarantine", "#{appdir}/Simple Voice.app"]
    end
